...
namespace Sgml
{
    ...
    /// </summary>
    [System.Serializable]
    public class SgmlParseException : System.Exception
    {
        ...
        public SgmlParseException(string message, System.Exception innerException)
    ...
    public enum LiteralType
    {
        ...
        /// CDATA text literals.
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
        CDATA,
    ...
    public class Entity : System.IDisposable
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1705", Justification = "The capitalisation is correct since EOF is an acronym.")]
        ...
        private System.Uri m_resolvedUri;
        private System.IO.TextReader m_stm;
        ...
        /// <param name="proxy">The proxy server to use when retrieving any web content.</param>
        public Entity(string name, System.Uri baseUri, System.IO.TextReader stm, string proxy)
        {
            m_name = name;
            m_isInternal = true;
            m_stm = stm;
            ...
            m_proxy = proxy;
            m_isHtml = (string.Compare(name, "html", true, System.Globalization.CultureInfo.InvariantCulture) == 0);
        }
        ...
        public void Open(Entity parent, System.Uri baseUri)
        {
            ...
            if (m_isInternal)
            {
                if (this.m_literal != null)
                    this.m_stm = new System.IO.StringReader(this.m_literal);
            }
            ...
            else
            {
                if (baseUri != null)
                {
                    this.m_resolvedUri = new System.Uri(baseUri, this.m_uri);
                }
                else
                {
                    this.m_resolvedUri = new System.Uri(this.m_uri);
                }
                ...
                switch (this.m_resolvedUri.Scheme)
                {
                    ...
                    default:
                        ...
                        System.Net.HttpWebRequest wr = (System.Net.HttpWebRequest)System.Net.WebRequest.Create(ResolvedUri);
                        wr.UserAgent = "Mozilla/4.0 (compatible;);";
                        wr.Timeout = 10000; // in case this is running in an ASPX page.
                        if (m_proxy != null)
                            wr.Proxy = new System.Net.WebProxy(m_proxy);
                        wr.PreAuthenticate = false;
                        // Pass the credentials of the process. 
                        wr.Credentials = System.Net.CredentialCache.DefaultCredentials;

                        System.Net.WebResponse resp = wr.GetResponse();
                        System.Uri actual = resp.ResponseUri;
                        if (string.Compare(actual.AbsoluteUri, this.m_resolvedUri.AbsoluteUri, true, System.Globalization.CultureInfo.InvariantCulture) != 0)
                        {
                            this.m_resolvedUri = actual;
                        }
                        string contentType = resp.ContentType.ToLower(System.Globalization.CultureInfo.InvariantCulture);
                        ...
                        if (i >= 0)
                        {
                            ...
                            if (j > 0)
                            {
                                ...
                                try
                                {
                                    e = System.Text.Encoding.GetEncoding(charset);
                                }
        ...
        public string ScanToken(System.Text.StringBuilder sb, string term, bool nmtoken)
        {
            if (sb == null)
            ...
            {
                throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Invalid name start character '{0}'", ch));
            }
            ...
            while (ch != Entity.EOF && term.IndexOf(ch) < 0)
            {
                ...
                else
                {
                    throw new SgmlParseException(
                        string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Invalid name character '{0}'", ch));
                }
                ch = ReadChar();
            }
        ...
        public string ScanLiteral(System.Text.StringBuilder sb, char quote)
        {
            if (sb == null)
                throw new System.ArgumentNullException("sb");
        ...
        public string ScanToEnd(System.Text.StringBuilder sb, string type, string terminators)
        {
            if (terminators == null)
                throw new System.ArgumentNullException("terminators");
        ...
        public void Error(string msg, char ch)
        {
            ...
            throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, msg, str), this);
        }
        ...
        {
            throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, msg, x), this);
        }
        ...
        {
            throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, msg, arg), this);
        }
        ...
        {
            return string.Compare(token, "CDATA", true, System.Globalization.CultureInfo.InvariantCulture) == 0 ||
                   string.Compare(token, "SDATA", true, System.Globalization.CultureInfo.InvariantCulture) == 0 ||
                   string.Compare(token, "PI", true, System.Globalization.CultureInfo.InvariantCulture) == 0;
        }
        ...
        : System.IO.TextReader
    {
        ...
        public HtmlStream(System.IO.Stream stm, System.Text.Encoding defaultEncoding)
        {
            if (defaultEncoding == null) defaultEncoding = System.Text.Encoding.UTF8; // default is UTF8
            if (!stm.CanSeek)
            {
            ...
            if (this.m_decoder == null)
            {
                ...
                System.Text.Decoder sd = SniffEncoding();
                if (sd != null)
                {
                    this.m_decoder = sd;
                }
            ...
            this.stm.Seek(0, System.IO.SeekOrigin.Begin);
        ...
        private static System.IO.Stream CopyToMemoryStream(System.IO.Stream s)
        {
        ...
        internal static System.Text.Decoder AutoDetectEncoding(byte[] buffer, ref int index, int length)
        {
            if (4 <= (length - index))
            {
                ...
                switch (w)
                {
                    case 0xfeff:
                        index += 2;
                        return System.Text.UnicodeEncoding.BigEndianUnicode.GetDecoder();

                    case 0xfffe:
                        index += 2;
                        return new System.Text.UnicodeEncoding(false, false).GetDecoder();
        ...
        private string SniffAttribute(string name)
        {
            SniffWhitespace();
            string id = SniffName();
            if (string.Compare(name, id, true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
                SniffWhitespace();
                if (SniffPattern("="))
                {
                        ...
                        if (httpequiv != null && StringUtilities.EqualsIgnoreCase(httpequiv, "content-type") && content != null)
                        {
                            ...
                            if (j >= 0)
                            {
                                ...
                                if (j >= 0)
                                {
                                    ...
                                    try
                                    {
                                        System.Text.Encoding e = System.Text.Encoding.GetEncoding(charset);
                                        this.m_encoding = e;
                                        return e.GetDecoder();
                                    }
                                    catch (System.ArgumentException) { }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811", Justification = "Kept for potential future usage.")]
        ...
        public override int Read(char[] buffer, int start, int length)
        {
            ...
            if (pos < used)
            {
                length = System.Math.Min(used - pos, length);
                System.Array.Copy(this.m_buffer, pos, buffer, start, length);
                pos += length;
                return length;
            }
            return 0;
        ...
        : System.Text.Decoder
    {
        ...
        internal static char UnicodeToUTF16(uint code)
        {
    ...
    internal class Ucs4DecoderBigEngian
        : Ucs4Decoder
    {
        internal override int GetFullChars(byte[] bytes, int byteIndex, int byteCount, char[] chars, int charIndex)
        {
            ...
            for (i = byteIndex, j = charIndex; i + 3 < byteCount;)
            {
                ...
                if (code > 0x10FFFF)
                {
                    throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Invalid character 0x{0:x} in encoding", code));
                }
                else if (code > 0xFFFF)
                {
    ...
    public class ElementDecl
    {
        ...
        private System.Collections.Generic.Dictionary<string, AttDef> m_attList;
        ...
        {
            if (m_attList == null)
                throw new System.InvalidOperationException("The attribute list for the element declaration has not been initialised.");

            AttDef a;
            m_attList.TryGetValue(name.ToUpper(System.Globalization.CultureInfo.InvariantCulture), out a);
            return a;
        }
        ...
        public void AddAttDefs(System.Collections.Generic.Dictionary<string, AttDef> list)
        {
            if (list == null)
        ...
        public bool CanContain(string name, SgmlDtd dtd)
        {
            ...
            if (m_exclusions != null)
            {
                ...
                {
                    if (string.Compare(s, name, System.StringComparison.InvariantCultureIgnoreCase) == 0)
                        return false;
                }
            }
        ...
        public void SetDeclaredContent(string dc)
        {
            ...
            switch (dc)
            {
                ...
                case "CDATA":
                    ...
                    break;
                default:
                    throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Declared content type '{0}' is not supported", dc));
            }
        }
    ...
    public class Group
    {
        ...
        private System.Collections.ArrayList Members;
        ...
        public void AddSymbol(string sym)
        {
            if (string.Compare(sym, "#PCDATA", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
                Mixed = true;
            }
            else
        ...
        public void AddConnector(char c)
        {
            ...
            {
                throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Missing token before connector '{0}'.", c));
            }
            ...
            {
                throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Connector '{0}' is inconsistent with {1} group.", c, m_groupType.ToString()));
            }
        ...
        {
            if (dtd == null)
                throw new System.ArgumentNullException("dtd");
            ...
            foreach (object obj in Members)
            {
                if (obj is string)
                {
                    if (string.Compare((string)obj, name, System.StringComparison.InvariantCultureIgnoreCase) == 0)
                        return true;
                }
            }
    ...
    public enum AttributeType
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1705", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1706", Justification = "This capitalisation is appropriate since the value it represents has all upper-case capitalisation.")]
        ID,
    ...
    public class AttDef
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1819", Justification = "Changing this would break backwards compatibility with previous code using this library.")]
        ...
        public void SetEnumeratedType(string[] enumValues, AttributeType type)
        {
            if (type != AttributeType.ENUMERATION && type != AttributeType.NOTATION)
                throw new System.ArgumentException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "AttributeType {0} is not valid for an attribute definition with an enumerated value.", type));
        ...
        public void SetType(string type)
        {
            switch (type)
            {
                ...
                case "NUTOKENS":
                    ...
                    break;
                default:
                    throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Attribute type '{0}' is not supported", type));
            }
        }
        ...
        public bool SetPresence(string token)
        {
            ...
            if (string.Compare(token, "FIXED", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
                m_presence = AttributePresence.Fixed;
            }
            else if (string.Compare(token, "REQUIRED", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
                m_presence = AttributePresence.Required;
                hasDefault = false;
            }
            else if (string.Compare(token, "IMPLIED", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
            ...
            {
                throw new SgmlParseException(string.Format(System.Globalization.CultureInfo.CurrentUICulture, "Attribute value '{0}' not supported", token));
            }
    ...
    */
    ...
    public class SgmlDtd
    {
        ...
        private System.Collections.Generic.Dictionary<string, ElementDecl> m_elements;
        private System.Collections.Generic.Dictionary<string, Entity> m_pentities;
        private System.Collections.Generic.Dictionary<string, Entity> m_entities;
        ...
        public SgmlDtd(string name, System.Xml.XmlNameTable nt)
        {
            this.m_name = name;
            this.m_elements = new System.Collections.Generic.Dictionary<string, ElementDecl>();
            this.m_pentities = new System.Collections.Generic.Dictionary<string, Entity>();
            this.m_entities = new System.Collections.Generic.Dictionary<string, Entity>();
        ...
        public static SgmlDtd Parse(System.Uri baseUri, string name, string pubid, string url, string subset, string proxy, System.Xml.XmlNameTable nt)
        {
        ...
        /// <param name="nt">The <see cref="XmlNameTable"/> is NOT used.</param>
        /// <returns>A new <see cref="SgmlDtd"/> instance that encapsulates the DTD.</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2000", Justification = "The entities created here are not temporary and should not be disposed here.")]
        public static SgmlDtd Parse(System.Uri baseUri, string name, System.IO.TextReader input, string subset, string proxy, System.Xml.XmlNameTable nt)
        {
            SgmlDtd dtd = new SgmlDtd(name, nt);
        ...
        {
            ElementDecl el;
            m_elements.TryGetValue(name.ToUpper(System.Globalization.CultureInfo.InvariantCulture), out el);
            return el;
        }

        //-------------------------------- Parser -------------------------
        private void PushEntity(System.Uri baseUri, Entity e)
        {
                ...
                switch (ch)
                {
                    ...
                    case '%':
                        ...
                        catch (System.Exception ex)
                        {
                            ...
                            System.Console.WriteLine(ex.Message + this.m_current.Context());
                        }
                        ch = this.m_current.Lastchar;
                        break;
                    default:
        ...
        void ParseMarkedSection()
        {
            ...
            if (string.Compare(name, "INCLUDE", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
                ParseIncludeSection();
            }
            else if (string.Compare(name, "IGNORE", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
            {
                ParseIgnoreSection();
            }
            else
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1822", Justification = "This is not yet implemented and will use 'this' in the future.")]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303", Justification = "The use of a literal here is only due to this not yet being implemented.")]
        private void ParseIncludeSection()
        {
            throw new System.NotImplementedException("Include Section");
        }
        ...
        string ScanName(string term)
        {
            ...
            if (ch == '%')
            {
                ...
                if (!e.IsInternal) throw new System.NotSupportedException("External parameter entity resolution");
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024", Justification = "This method creates and copies a dictionary, so exposing it as a property is not appropriate.")]
        public System.Collections.Generic.Dictionary<string, Entity> GetEntitiesLiteralNameLookup()
        {
            System.Collections.Generic.Dictionary<string, Entity> hashtable = new System.Collections.Generic.Dictionary<string, Entity>();
        ...
        private void ParseEntity()
        {
            ...
            else
            {
                ...
                {
                    extid = tok;
                    if (string.Compare(extid, "PUBLIC", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                    {
                        ch = this.m_current.SkipWhitespace();
                        if (ch == '"' || ch == '\'')
                        {
                    ...
                    else if (string.Compare(extid, "SYSTEM", true, System.Globalization.CultureInfo.InvariantCulture) != 0)
                    {
        ...
        private void ParseElementDecl()
        {
            ...
            ch = char.ToUpper(this.m_current.SkipWhitespace(), System.Globalization.CultureInfo.InvariantCulture);
            bool sto = false;
            bool eto = false;
            if (ch == 'O' || ch == '-')
            {
            ...
            {
                string atom = name.ToUpper(System.Globalization.CultureInfo.InvariantCulture);
            ...
            if (ch == '(')
            {
                ...
                while (ch != ')')
                {
                    ...
                    else
                    {
                        ...
                        token = token.ToUpper(System.Globalization.CultureInfo.InvariantCulture);
                        names.Add(token);
                    }
                    ch = this.m_current.SkipWhitespace();
        ...
        void ParseNameList(System.Collections.ArrayList names, bool nmtokens)
        {
            char ch = this.m_current.Lastchar;
            ch = this.m_current.SkipWhitespace();
            while (ch != Entity.EOF)
        ...
        void ParseAttList()
        {
            char ch = this.m_current.SkipWhitespace();
            string[] names = ParseNameGroup(ch, true);
            System.Collections.Generic.Dictionary<string, AttDef> attlist = new System.Collections.Generic.Dictionary<string, AttDef>();
        ...
        void ParseAttList(System.Collections.Generic.Dictionary<string, AttDef> list, char term)
        {
            char ch = this.m_current.SkipWhitespace();
            while (ch != term)
            {
        ...
        void ParseAttType(char ch, AttDef attdef)
        {
            ...
            else
            {
                ...
                if (string.Compare(token, "NOTATION", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                {
                    ch = this.m_current.SkipWhitespace();
                    if (ch != '(')
                    {
