...
namespace Sgml
{
    ...
    internal class HWStack
    {
        ...
        public object Push()
        {
            if (this.m_count == this.m_size)
            {
                ...
                if (this.m_items != null)
                    System.Array.Copy(this.m_items, newarray, this.m_size);
        ...
        {
            this.m_items[i] = null;
            System.Array.Copy(this.m_items, i + 1, this.m_items, i, this.m_count - i - 1);
            this.m_count--;
        }
    }
    ...
    internal class Node
    {
        ...
        internal System.Xml.XmlSpace Space;
        ...
        /// hence the Reset method. 
        /// </summary>
        public void Reset(string name, System.Xml.XmlNodeType nt, string value)
        {
            this.Value = value;
            this.Name = name;
            this.NodeType = nt;
        ...
        public Attribute AddAttribute(string name, string value, char quotechar, bool caseInsensitive)
        {
            ...
            for (int i = 0, n = this.attributes.Count; i < n; i++)
            {
                ...
                if (string.Compare(a.Name, name, caseInsensitive, System.Globalization.CultureInfo.InvariantCulture) == 0)
                {
                    return null;
                }
            }
        ...
        public void RemoveAttribute(string name)
        {
            for (int i = 0, n = this.attributes.Count; i < n; i++)
            {
                ...
                if (string.Compare(a.Name, name, true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                {
        ...
        : System.Xml.XmlReader
    {
        ...
        private System.Uri m_baseUri;
        private System.Text.StringBuilder m_sb;
        private System.Text.StringBuilder m_name;
        private System.IO.TextWriter m_log;
        ...
        private System.IO.TextReader m_inputStream;
        private string m_syslit;
        private string m_pubid;
        private string m_subset;
        private string m_docType;
        private System.Xml.WhitespaceHandling m_whitespaceHandling;
        private CaseFolding m_folding = CaseFolding.None;
        private bool m_stripDocType = true;
        //private string m_startTag;
        private System.Collections.Generic.Dictionary<string, string> unknownNamespaces = new System.Collections.Generic.Dictionary<string, string>();
        ...
        public SgmlReader(System.Xml.XmlNameTable nt)
        {
            Init();
        }
        ...
        private void LazyLoadDtd(System.Uri baseUri)
        {
            if (this.m_dtd == null)
            {
                if (string.IsNullOrEmpty(this.m_syslit))
                {
                    if (this.m_docType != null && StringUtilities.EqualsIgnoreCase(this.m_docType, "html"))
                    {
                        ...
                        if (stm != null)
                        {
                            ...
                            throw new System.ArgumentException($"No resource with name \"{name}\" found...");
                    }
                }
                else
                {
                    if (baseUri != null)
                    {
                        baseUri = new System.Uri(baseUri, this.m_syslit);
                    }
                    else if (this.m_baseUri != null)
                    {
                        baseUri = new System.Uri(this.m_baseUri, this.m_syslit);
                    }
                    else
                    {
                        baseUri = new System.Uri(new System.Uri(System.IO.Directory.GetCurrentDirectory() + "\\"), this.m_syslit);
                    }
            ...
            if (this.m_dtd != null && this.m_dtd.Name != null)
            {
                switch (this.CaseFolding)
                {
                    case CaseFolding.ToUpper:
                        this.m_rootElementName = this.m_dtd.Name.ToUpper(System.Globalization.CultureInfo.InvariantCulture);
                        break;
                    case CaseFolding.ToLower:
                        this.m_rootElementName = this.m_dtd.Name.ToLower(System.Globalization.CultureInfo.InvariantCulture);
                        break;
                    default:
        ...
        /// </summary>
        public System.IO.TextReader InputStream
        {
            get
            {
        ...
        {
            this.m_baseUri = new System.Uri(uri);
        }
        ...
        public string Href
        {
            ...
            set
            {
                ...
                if (this.m_baseUri == null)
                {
                    ...
                    {
                        this.m_baseUri = new System.Uri(this.m_href);
                    }
                    else
                    {
                        this.m_baseUri = new System.Uri("file:///" + System.IO.Directory.GetCurrentDirectory() + "//");
                    }
                }
            }
        }
        ...
        /// </summary>
        public System.IO.TextWriter ErrorLog
        {
            get
            {
                return this.m_log;
        ...
        public string ErrorLogFile
        {
            ...
            set
            {
                ...
                this.m_log = new System.IO.StreamWriter(value);
            }
        }
        ...
        private void Log(string msg, params string[] args)
        {
            if (ErrorLog != null)
            {
                string err = string.Format(System.Globalization.CultureInfo.CurrentUICulture, msg, args);
        ...
        private void Init()
        {
            ...
            this.m_node = Push(null, System.Xml.XmlNodeType.Document, null);
            this.m_node.IsEmpty = false;
            this.m_sb = new System.Text.StringBuilder();
            this.m_name = new System.Text.StringBuilder();
            this.m_poptodepth = 0;
            this.m_current = null;
            this.m_partial = '\0';
            this.m_endTag = null;
        ...
        private Node Push(string name, System.Xml.XmlNodeType nt, string value)
        {
        ...
        /// </remarks>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1820", Justification = "Cannot use IsNullOrEmpty in a switch statement and swapping the elegance of switch for a load of 'if's is not worth it.")]
        public override string NamespaceURI
        {
            get
            {
                // SGML has no namespaces, unless this turned out to be an xmlns attribute.
                if (this.m_state == State.Attr && (string.Compare(this.m_a.Name, "xmlns", true, System.Globalization.CultureInfo.InvariantCulture) == 0))
                {
                ...
                switch (Prefix)
                {
                    ...
                    case "":
                        if (NodeType == System.Xml.XmlNodeType.Attribute)
                        {
                            // attributes without a prefix are never in any namespace
                            return string.Empty;
                        }
                        else if (NodeType == System.Xml.XmlNodeType.Element)
                        {
                    ...
                    default:
                        {
                            string value;
                            if ((NodeType == System.Xml.XmlNodeType.Attribute) || (NodeType == System.Xml.XmlNodeType.Element))
                            {
        ...
        public override System.Xml.XmlSpace XmlSpace
        {
            get
            {
                for (int i = this.m_stack.Count - 1; i > 1; i--)
                {
                    ...
                    System.Xml.XmlSpace xs = n.Space;
                    if (xs != System.Xml.XmlSpace.None)
                        return xs;
                }
        ...
        public override int AttributeCount
        {
            get
            {
                if (this.m_state == State.Attr || this.m_state == State.AttrValue)
                    return 0;
                else if (this.m_node.NodeType == System.Xml.XmlNodeType.Element || this.m_node.NodeType == System.Xml.XmlNodeType.DocumentType)
        ...
        public override bool MoveToElement()
        {
            if (this.m_state == State.Attr || this.m_state == State.AttrValue)
            {
                ...
                return (this.m_node.NodeType == System.Xml.XmlNodeType.Element);
        }
        ...
        private void OpenInput()
        {
            ...
            {
                throw new System.InvalidOperationException("You must specify input either via Href or InputStream properties");
            }
        ...
        public override bool Read()
        {
            ...
            while (!foundnode)
            {
                switch (this.m_state)
                {
                    ...
                    case State.Eof:
                        ...
                        break;
                    case State.EndTag:
                        if (string.Compare(this.m_endTag, this.m_node.Name, true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                        {
                            Pop(); // we're done!
                            this.m_state = State.Markup;
                            goto case State.Markup;
                    ...
                    case State.AutoClose:
                        ...
                        if (this.m_stack.Count <= this.m_poptodepth)
                        {
                            ...
                            else if (this.m_node.NodeType == System.Xml.XmlNodeType.Document)
                            {
                    ...
                    case State.PartialText:
                        ...
                        {
                            this.m_node.NodeType = System.Xml.XmlNodeType.Whitespace;
                        }
                ...
                if (foundnode && this.m_node.NodeType == System.Xml.XmlNodeType.Whitespace && this.m_whitespaceHandling == System.Xml.WhitespaceHandling.None)
                {
            ...
            if (!m_foundRoot && (this.NodeType == System.Xml.XmlNodeType.Element ||
                    this.NodeType == System.Xml.XmlNodeType.Text ||
                    this.NodeType == System.Xml.XmlNodeType.CDATA))
            {
                m_foundRoot = true;
                if (this.IsHtml && (this.NodeType != System.Xml.XmlNodeType.Element ||
                    string.Compare(this.LocalName, "html", true, System.Globalization.CultureInfo.InvariantCulture) != 0))
                {
                    ...
                    Node root = Push("html", System.Xml.XmlNodeType.Element, null);
        ...
        private bool ParseTag(char ch)
        {
            ...
            else if (ch == '!')
            {
                ...
                else
                {
                    ...
                    if (string.Compare(name, "DOCTYPE", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                    {
                        ParseDocType();
                        ...
                        {
                            this.m_node.NodeType = System.Xml.XmlNodeType.DocumentType;
                            return true;
                        }
                    }
                    else
        ...
        private bool ParseStartTag(char ch)
        {
            ...
            Node n = Push(name, System.Xml.XmlNodeType.Element, null);
            n.IsEmpty = false;
            Validate(n);
            ...
            while (ch != Entity.EOF && ch != '>')
            {
                ...
                ch = this.m_current.SkipWhitespace();
                if (string.Compare(aname, ",", true, System.Globalization.CultureInfo.InvariantCulture) == 0 ||
                    string.Compare(aname, "=", true, System.Globalization.CultureInfo.InvariantCulture) == 0 ||
                    string.Compare(aname, ":", true, System.Globalization.CultureInfo.InvariantCulture) == 0 ||
                    string.Compare(aname, ";", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                {
                    continue;
        ...
        private bool ParseEndTag()
        {
            ...
            {
                Node n = (Node)this.m_stack[i];
                if (string.Compare(n.Name, name, caseInsensitive, System.Globalization.CultureInfo.InvariantCulture) == 0)
                {
        ...
        private bool ParseAspNet()
        {
            ...
            Push(null, System.Xml.XmlNodeType.CDATA, value);
            return true;
        }
        ...
        private bool ParseComment()
        {
            ...
            Push(null, System.Xml.XmlNodeType.Comment, value);
            return true;
        }
        ...
        private bool ParseConditionalBlock()
        {
            ...
            else if (string.Compare(name, "CDATA", true, System.Globalization.CultureInfo.InvariantCulture) != 0)
            {
        ...
        private void ParseDocType()
        {
            ...
            Push(name, System.Xml.XmlNodeType.DocumentType, null);
            ch = this.m_current.SkipWhitespace();
            if (ch != '>')
            {
                string subset = "";
                ...
                if (ch != '[')
                {
                    ...
                    if (string.Compare(token, "PUBLIC", true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                    {
                        ch = this.m_current.SkipWhitespace();
                        if (ch == '\"' || ch == '\'')
                        {
                    ...
                    else if (string.Compare(token, "SYSTEM", true, System.Globalization.CultureInfo.InvariantCulture) != 0)
                    {
                ...
                if (this.m_dtd != null && string.Compare(this.m_dtd.Name, name, true, System.Globalization.CultureInfo.InvariantCulture) != 0)
                {
                    throw new System.InvalidOperationException("DTD does not match document type");
                }
        ...
        private bool ParsePI()
        {
            ...
            if (string.Compare(name, "xml", true, System.Globalization.CultureInfo.InvariantCulture) != 0)
            {
                Push(name, System.Xml.XmlNodeType.ProcessingInstruction, value);
                return true;
            }
        ...
        private bool ParseText(char ch, bool newtext)
        {
            ...
            Push(null, System.Xml.XmlNodeType.Text, value);
            return ws;
        }
        ...
        /// </remarks>
        private string ScanLiteral(System.Text.StringBuilder sb, char quote)
        {
            sb.Length = 0;
            char ch = this.m_current.ReadChar();
            ...
            while (ch != Entity.EOF)
            {
                if (ch == '<')
                {
                    ...
                    else if (ch == '/')
                    {
                        ...
                        if (ParseEndTag() && string.Compare(this.m_endTag, this.m_node.Name, true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                        {
        ...
        private void ExpandEntity(System.Text.StringBuilder sb, char terminator)
        {
            char ch = this.m_current.ReadChar();
            if (ch == '#')
            {
                ...
                if (this.m_dtd != null && !string.IsNullOrEmpty(name))
                {
                    ...
                    if (e != null)
                    {
                        ...
                        else
                        {
                            ...
                            e.Open(this.m_current, new System.Uri(e.Uri));
                            this.m_current = ex;
                            this.m_current.ReadChar();
                            return;
                        }
        ...
        {
            if (this.m_node.NodeType == System.Xml.XmlNodeType.Element)
            {
                this.m_sb.Length = 0;
                while (Read())
                {
        ...
        {
            System.IO.StringWriter sw = new System.IO.StringWriter(System.Globalization.CultureInfo.InvariantCulture);
            ...
            switch (this.NodeType)
            {
                case System.Xml.XmlNodeType.Element:
                    Read();
                    while (!this.EOF && this.NodeType != System.Xml.XmlNodeType.EndElement)
                    {
        ...
        public override void ResolveEntity()
        {
            ...
            throw new System.InvalidOperationException("Not on an entity reference.");
        }
        ...
        public override bool ReadAttributeValue()
        {
            ...
            else if (this.m_state == State.AttrValue)
            {
                ...
                throw new System.InvalidOperationException("Not on an attribute.");
        }
        ...
        private static bool ValidAttributeName(string name)
        {
            try
            {
                System.Xml.XmlConvert.VerifyNMTOKEN(name);
                int index = name.IndexOf(':');
                if (index >= 0)
                {
                    System.Xml.XmlConvert.VerifyNCName(name.Substring(index + 1));
                }
        ...
        private void ValidateContent(Node node)
        {
            if (node.NodeType == System.Xml.XmlNodeType.Element)
            {
                ...
                {
                    Pop();
                    Push(null, System.Xml.XmlNodeType.Text, "<" + node.Name + ">");
                    return;
                }
            }
            ...
            if (this.m_dtd != null)
            {
                ...
                string name = node.Name.ToUpper(System.Globalization.CultureInfo.InvariantCulture); // DTD is in upper case
                int i = 0;
                ...
                if (node.DtdType != null)
                {
                    ...
                    for (i = top; i > 0; i--)
                    {
                        ...
                        if (f != null)
                        {
                            if ((i == 2) && (string.Compare(f.Name, "BODY", true, System.Globalization.CultureInfo.InvariantCulture) == 0)) // NOTE (steveb): never close the BODY tag too early
                                break;
                            else if (string.Compare(f.Name, this.m_dtd.Name, true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                ...
                else if (i < top)
                {
                    ...
                    if (i == top - 1 && string.Compare(name, n.Name, true, System.Globalization.CultureInfo.InvariantCulture) == 0)
                    {
